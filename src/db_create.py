...
from braking import DATA_ROOT, DATETIME_FMT, NUMERIC_COLUMNS
from braking.io import load_all_seqs_names
from braking.utils import seq_name_to_dt
...
def seq_to_df(start_dt: datetime, end_dt: datetime, columns: str,
...
if __name__ == "__main__":
    ...
    for seq in (pbar := tqdm(seqs)):
        ...
        df = seq_to_df(start_dt, end_dt, args.columns, db_cnx, braking_frames=braking_frames)
